...
import 'package:swim/features/home/screens/home_screen.dart'; // 새로운 홈 화면 추가
import 'package:swim/features/splash/splash_screen.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/splash',
      routes: {
        '/splash': (context) => const SplashScreen(),    // 스플래시 화면 추가
